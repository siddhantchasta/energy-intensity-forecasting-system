...
st.markdown(
    "<h1 style='text-align: center;'>Energy Intensity Forecast Application</h1>",
    unsafe_allow_html=True
)


img = Image.open("Images/banner.jpg")
img = img.resize((1200, 250))

st.image(img)

st.markdown(
    "<p style='text-align: center; color: #94A3B8;'>"
    "Machine Learning–driven insights for building energy efficiency"
    "</p>",
    unsafe_allow_html=True
)
